...
class City(TimeStampedModel):
    ...
    name = db_models.CharField(
        max_length=base_constants.BaseConstants.CITY_NAME_MAX_LENGTH, unique=True
    )
...
class Genre(TimeStampedModel):
    ...
    name = db_models.CharField(
        max_length=base_constants.BaseConstants.GENRE_NAME_MAX_LENGTH, unique=True
    )
...
class Language(TimeStampedModel):
    ...
    name = db_models.CharField(
        max_length=base_constants.BaseConstants.LANGUAGE_NAME_MAX_LENGTH, unique=True
    )
