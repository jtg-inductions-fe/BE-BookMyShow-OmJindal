...
class MovieFilter(django_filters.FilterSet):
    ...
    Attributes:
        genres (NumberInFilter): Filter by multiple genre IDs (comma-separated).
        languages (NumberInFilter): Filter by multiple language IDs (comma-separated).
        cinemas (NumberInFilter): Filter by cinema IDs via slots relationship.
